...
import 'package:f_simple_web_retool/data/datasources/remote/i_user_datasource.dart'
    as _i6;
import 'package:f_simple_web_retool/domain/models/user.dart' as _i5;
...
class MockIUserRepository extends _i1.Mock implements _i3.IUserRepository {
  ...
  @override
  _i4.Future<bool> addUser(_i5.User? user) => (super.noSuchMethod(
        Invocation.method(
          #addUser,
          [user],
        ),
...
///
/// See the documentation for Mockito's code generation for more information.
class MockIUserDataSource extends _i1.Mock implements _i6.IUserDataSource {
  MockIUserDataSource() {
    _i1.throwOnMissingStub(this);
  }
